...
- **Ensemble:** `docs_private/20_notebooks_for_devel/function_0_devel.ipynb` (if present) illustrates ensemble acquisition (EI+PI+UCB): centroid when they disagree, EI when they agree. See `docs_private/40_notes_and_references/ensemble_acquisition_guide.md`.
